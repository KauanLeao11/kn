...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($employee && password_verify($password, $employee['password'])) {
        ...
        echo "Usuário ou senha está incorretos.";
    }
}
?>
...
<head>
	...
	<link rel="icon" type="image/png" href="images/icons/13-131873_home-icons-png-transparent-home-icon-green-png.png"/>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/icons/boloKN.jpg" alt="IMG">
				</div>
